...
export class MpaFormComponent implements PDFFormInterface, OnInit {
  ...
  fields: PDFField[] = [
    ...
    { controlName: 'field22', pdfField: 'form_MPOA[0].page3[0].s6[0].p3[0].TextField3[0]', label: 'State of Texas County of', tooltip: 'State of Texas County of', type: 'text' },
    ...
    { controlName: 'field26', pdfField: 'form_MPOA[0].page3[0].s6[0].p4[0].p2[0].left[0].p2[0].TextField4[0]', label: 'Print name', tooltip: 'Enter value for Field 26', type: 'text' },
    { controlName: 'field27', pdfField: 'form_MPOA[0].page3[0].s6[0].p4[0].p2[0].left[0].p3[0].TextField2[0]', label: 'My commission expires', tooltip: 'Enter value for Field 27', type: 'text' },
    { controlName: 'field28', pdfField: 'form_MPOA[0].page4[0].s7[0].p2[0].p1[0].NumericField1[0]', label: 'Day', tooltip: 'Enter value for Field 28', type: 'text' },
    { controlName: 'field29', pdfField: 'form_MPOA[0].page4[0].s7[0].p2[0].p1[0].DateField2[0]', label: 'Month & year', tooltip: 'Enter value for Field 29', type: 'text' },
    { controlName: 'field30', pdfField: 'form_MPOA[0].page4[0].s7[0].p2[0].p2[0].TextField2[0]', label: 'city and state', tooltip: 'Enter value for Field 30', type: 'text' },
